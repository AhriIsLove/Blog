...
const ItEditPage = () => {
    ...
    useEffect(() => {
        ...
        getItDetail(itId).then(data => {
            if (data !== undefined) {
                // IT 정보 설정
                setIt(data);
                setItTypeSelect(data.type);
        ...
        <div className="regist-container">
            ...
            <form className="regist-form" onSubmit={handleSubmit}>
                <div className="regist-field">
                    ...
                    value={it.title ?? ''} onChange={(e) => setIt({ ...it, title: e.target.value })} />
                </div>
                <div className="regist-field">
                ...
                <div className="regist-field">
                    ...
                    <textarea id="itTags" name="itTags" placeholder="#태그 #태그" rows={2} className="regist-textarea" value={it.tags ?? ''} onChange={(e) => setIt({ ...it, tags: e.target.value })} />
                </div>
                <div className="regist-row">
                    ...
                    <button
                        ...
                        onClick={() => window.location.href = `${process.env.PUBLIC_URL}/study/it/${itId}`}
                    >
                        취소
                    </button>
                </div>
